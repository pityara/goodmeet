...
(function() {
  $(document).on('turbolinks:load', function() {
    return $("a[data-remote]").on("ajax:success", function(e, data, status, xhr) {
      ...
      return $(current_comment).fadeOut(200);
    });
  });

  $(document).on('turbolinks:load', function() {
    return $(".all_comments").on("ajax:success", function(e, data, status, xhr) {
      return alert(data);
    });
  });
...
(function() {
  jQuery(function() {
    return $('#meeting_date').datepicker({
      dateFormat: 'dd-mm-yy'
    }).val();
  });

  $(document).on('turbolinks:load', function() {
    return $('.deleteAction').click(function() {
      var current_meeting;
  ...
  $(document).on('turbolinks:load', function() {
    return $('.show_comments').on("ajax:success", function(e, data, status, xhr) {
      $('.comments').fadeIn(200);
